...
if __name__ == "__main__":
    ...
    print(f"  │  URL:  https://autorca-api.onrender.com:{PORT}/logs                      │")
    print("  │  Returns plain text logs                               │")
    print("  └────────────────────────────────────────────────────────┘")
    print()
    print("  ┌─ Grafana Loki ─────────────────────────────────────────┐")
    print(f"  │  URL:    https://autorca-api.onrender.com:{PORT}                          │")
    ...
    print(f"  │  Endpoint:  https://autorca-api.onrender.com:{PORT}                       │")
